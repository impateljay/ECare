...
public class BillsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rvContacts = (RecyclerView) findViewById(R.id.bills_recyclerview);
        // Initialize contacts
...
//                                for (DataSnapshot appleSnapshot: dataSnapshot.getChildren()) {
    ...
    private void collectPhoneNumbers(Map<String, Object> users) {
        ...
        if (users != null && !users.isEmpty()) {
            contacts.clear();
            contacts.add(new Appointment("<b>Date</b>", "<b>Amount</b>", "<b>Doctor Name</b>", ""));
            ...
            for (Map.Entry<String, Object> entry : users.entrySet()) {
                ...
                String doctor = (String) singleUser.get("doctor");
                String patient = (String) singleUser.get("patient");
                contacts.add(new Appointment(date, "Rs.500", doctor, patient));
